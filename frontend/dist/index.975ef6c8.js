...
window.obtainCarreras = function() {
    (0, _axiosDefault.default).get('http://localhost:8080/carreras').then((response)=>{
        ...
        carrerasList.forEach((carrera)=>{
            ...
            li.appendChild(document.createTextNode(carrera.edicion + ' ' + carrera.competicion + ' . ' + 'Tu cita es el ' + carrera.fecha + ". \xa1\xa1\xa1A por los " + carrera.distancia + " kil\xf3metros!!!"));
